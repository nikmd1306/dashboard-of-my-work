const ru = {
  ...
  dashboard: {
    ...
    empty: {
      ...
      description:
        "Здесь появится сводка, когда будут добавлены потоки работы и записи.",
    },
  },
  ...
  time: {
    ...
    empty: {
      ...
      description: "Здесь появится учёт времени по потокам работы.",
    },
  },
  ...
  finances: {
    ...
    empty: {
      title: "Записей пока нет",
      description: "Здесь появятся доходы и расходы по потокам работы.",
    },
  },
